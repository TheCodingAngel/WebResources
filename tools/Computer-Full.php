...
<head>
  ...
  <script type="text/javascript" defer src="scripts/Computer/wizard_full.js"></script>
  ...
  <script type="text/javascript" defer src="scripts/Computer/assembler.js"></script>
...
<?php $page->printBreadcrumb('Character-Oriented Decimal Computer', 'Tools'); ?>
    ...
    <div class="toolbar-horizontal">
      ...
      -->
      <a href="https://TheCodingAngel.org/tools/arch/Computer-Full.zip">
  ...
  <div id="simulator" class="sidebar-horizontal flex-row flex-shrink mainbody">
    ...
    <div id="inputSection" class="section-input sidebar-vertical flex-column flex-stretch-ortogonal input_bigger asm_width bg_slight">
      <div class="flexbar">
        ...
        <button id="assembleAtStartAddress" class="button button_style" onclick="Assembler.assembleAtStartAddress()">Assemble at Selection Start</button>
      </div>

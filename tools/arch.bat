...
%PHP% %FN_RCA_301_FULL%.php > %FN_RCA_301_FULL%.html
...
echo %FN_CHARS%.zip
%PHP% %FN_CHARS%.php > %FN_CHARS%.html
%ARCH% --exclude-vcs ^
...
%PHP% %FN_EXTENDED_ASCII%.php > %FN_EXTENDED_ASCII%.html
%ARCH% --exclude-vcs ^
...
%PHP% %FN_CODEPOINTS%.php > %FN_CODEPOINTS%.html
...
set "FN_TOOLS=Tools"
echo %FN_TOOLS%.zip
%ARCH% --exclude-vcs --exclude "*_demo.*" ^

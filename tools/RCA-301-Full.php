...
<head>
  ...
  <script type="text/javascript" defer src="scripts/Rca301/wizard_full.js"></script>
...
<div id="pageHeader" class="page-header flex-row flex-stretch-ortogonal navdirection">
  <div class="containertop">
    ...
    <div class="toolbar-horizontal">
      ...
      -->
      <a href="https://TheCodingAngel.org/tools/arch/RCA-301-Full.zip">
        <svg width="24" height="24" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512">
          <title>Download Offline Copy (Open RCA-301-Full.html)</title>

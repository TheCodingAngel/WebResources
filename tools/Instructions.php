...
<?php $page->printBreadcrumb('Instructions', 'Tools'); ?>
    ...
    <div class="toolbar-horizontal">
      ...
      <a href="https://TheCodingAngel.org/tools/arch/Instructions.zip">
        <svg width="24" height="24" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512">
          <title>Download Offline Copy (Open Instructions.html)</title>
...
Delay of 0 <strong>blocks the page</strong> and the execution <strong>cannot be stopped by the user</strong>.<br><br></li>
...
<li>1 character - <?php $page->printInternalLink("suffix", "Suffixes"); ?></li>
...
<p>
Depending on the <?php $page->printInternalLink("suffix", "Suffixes"); ?> the operands may be treated as values,
<?php $page->printInternalLink("register identifiers", "Registers"); ?> or memory addresses.
</p>
<br>
...
<ul>
<li>in the <?php $page->printInternalLink("counter register", "Registers"); ?> (ECX) for <?php $page->printInternalLink("addresses or pointers", "Suffixes"); ?>;<br>
if ECX has zero or an invalid number then a default value of 4 is used;</li>
<li>the register size for <?php $page->printInternalLink("register identifiers", "Registers"); ?>;</li>
